...
DEMO_STUDENTS = [
    ...
    ("SKP-IT-B01", "Karthikeyan R",      "IT-B", 88, 82, 85, 4.5),
    ("SKP-IT-B02", "Divya Lakshmi",      "IT-B", 90, 85, 88, 5.0),
    ("SKP-IT-C01", "Suriya Prakash",     "IT-C", 87, 80, 84, 4.0),
    ("SKP-IT-A03", "Nandhini S",         "IT-A", 93, 87, 91, 5.5),
    ("SKP-IT-B03", "Hariharan V",        "IT-B", 89, 83, 86, 4.5),
    ("SKP-IT-C02", "Swetha Ramesh",      "IT-C", 91, 86, 89, 5.0),

    # ── AVERAGE (10) ─────────────────────────────────────────────────────────
    ("SKP-IT-A04", "Muthu Krishnan",     "IT-A", 76, 62, 68, 3.0),
    ("SKP-IT-A05", "Sangeetha P",        "IT-A", 78, 65, 70, 3.5),
    ("SKP-IT-B04", "Vigneshwaran K",     "IT-B", 74, 58, 65, 2.5),
    ("SKP-IT-B05", "Tamilselvi M",       "IT-B", 77, 63, 67, 3.0),
    ("SKP-IT-C03", "Saravanan J",        "IT-C", 75, 60, 66, 2.5),
    ("SKP-IT-C04", "Kavitha Devi",       "IT-C", 79, 64, 69, 3.0),
    ("SKP-IT-A06", "Balamurugan S",      "IT-A", 73, 57, 63, 2.5),
    ("SKP-IT-B06", "Meenakshi R",        "IT-B", 76, 61, 66, 3.0),
    ("SKP-IT-C05", "Dinesh Kumar P",     "IT-C", 80, 66, 71, 3.5),
    ("SKP-IT-A07", "Jayashree V",        "IT-A", 75, 59, 64, 2.5),

    # ── AT RISK (7) ──────────────────────────────────────────────────────────
    ("SKP-IT-A08", "Ranjith Kumar",      "IT-A", 48, 32, 38, 1.0),
    ("SKP-IT-B07", "Deepika S",          "IT-B", 52, 38, 42, 1.5),
    ("SKP-IT-C06", "Manikandan R",       "IT-C", 45, 28, 35, 0.5),
    ("SKP-IT-B08", "Sathya Priya",       "IT-B", 55, 40, 45, 1.5),
    ("SKP-IT-C07", "Vikram S",           "IT-C", 50, 35, 40, 1.0),
    ("SKP-IT-A09", "Lakshmi Priya",      "IT-A", 58, 42, 48, 2.0),
    ("SKP-IT-C08", "Ashwin Kumar",       "IT-C", 42, 30, 33, 0.5),
]
