...
const proposed = [
  ...
  'AI-only explanation via Gemini 2.5 Flash (4-key rotation, no rule-based)',
  'Personalised 4-section advisory: explanation, risk factors, action plan, 7-day plan',
  'Advisory caching (SHA-256 hash) — instant repeat predictions, no AI re-call',
  'Multi-key Gemini rotation (Key 1→4 → RuntimeError) — zero rate-limit failures',
  ...
  'Async batch CSV upload with real-time AI progress tracking',
  ...
  'Per-cluster teacher-friendly AI insights',
...
const workflow = [
  ...
  { n: 3, title: 'AI Explanation',        color: '#c084fc', desc: 'Gemini 2.5 Flash (4-key rotation, AI-only) generates a grounded explanation + risk factors + priority action plan + 7-day study schedule — all in a single structured API call.' },
  { n: 4, title: 'Advisory & Cache',      color: '#f472b6', desc: 'The full AI advisory is cached by student ID + metrics hash. Repeat predictions return instantly from cache — no AI call needed. Demo reset is instant (3 s) from cached advisories.' },
...
const tech = [
  ...
  { l: 'AI Layer',   t: 'Google Gemini 2.5 Flash — 4-key rotation, AI-only (no rule-based fallback)' },
  { l: 'AI Cache',   t: 'SQLite advisory_cache — SHA-256 key, instant repeat responses'         },
...
const viva = [
  ...
  'AI-only explanation panel (Gemini 2.5 Flash — 4-key rotation)',
  'Personalised 4-section advisory (explanation, risk factors, action plan, 7-day plan)',
  'Multi-key Gemini rotation — zero rate-limit failures in demo',
  'Advisory caching (SHA-256 hash) — instant repeat predictions',
  'Async batch CSV upload with real-time AI progress bar',
  'Demo reset instant from cache (~3 s, no AI calls)',
  ...
  'Teacher-friendly cluster insights (AI-driven, data-derived)',
      ...
      <div className="rounded-2xl p-5 animate-fade-up s4 card-dark"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs">
          {[
            ...
            { icon: BrainCircuit, color: '#c084fc', label: 'Explainable AI',           desc: 'Every prediction comes with a Gemini 2.5 Flash-generated natural language rationale — explanation, risk factors, action plan, and 7-day schedule — citing the exact metrics that drove the outcome.' },
